        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="space-y-4">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className="px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-300 text-xs font-bold flex items-center gap-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4">
                <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
                  <div className="text-[11px] text-slate-400">Davomiyligi:</div>
                ...
                <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
                  <div className="text-[11px] text-slate-400">Haftasiga:</div>
                  <div className="text-sm font-bold text-white flex items-center gap-1.5 mt-0.5">
                ...
                <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
                  <div className="text-[11px] text-slate-400">Tahsil olganlar:</div>
                  <div className="text-sm font-bold text-white flex items-center gap-1.5 mt-0.5">
                ...
                <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
                  <div className="text-[11px] text-slate-400">Sertifikat:</div>
                  <div className="text-sm font-bold text-white flex items-center gap-1.5 mt-0.5">
            ...
            <div className="relative aspect-[16/9] rounded-3xl overflow-hidden bg-slate-800 border border-slate-700/80 shadow-2xl">
              <img
                src={course.image}
                alt={course.title}
            ...
            <div className="p-8 rounded-3xl bg-slate-900/60 border border-slate-800 space-y-6">
              ...
              <div className="pt-4 border-t border-slate-800/80">
                <h3 className="text-sm font-bold text-white mb-3">Kursda nimalarga ega bo'lasiz?</h3>
                  ...
                  return (
                    ...
                    >
                      <button
                        ...
                        className="w-full p-4 sm:p-5 flex items-center justify-between text-left hover:bg-slate-900/80 transition-colors"
                      >
                        <div className="flex items-center gap-3">
                          <div className="w-7 h-7 rounded-lg bg-indigo-600/20 border border-indigo-500/30 text-indigo-400 text-xs font-bold flex items-center justify-center shrink-0">
                            0{module.module}
                          </div>
                          <div>
                            ...
                            <div className="text-[11px] text-slate-400">{module.duration}</div>
                          </div>
                        </div>
                        {isOpen ? (
                      ...
                      {isOpen && (
                        <div className="px-5 pb-5 pt-1 space-y-2 border-t border-slate-800/60 bg-slate-900/30">
              ...
              <div className="p-8 rounded-3xl bg-slate-900/60 border border-slate-800 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                  <img
                    src={teacher.avatar}
                    alt={teacher.name}
                    className="w-20 h-20 rounded-2xl object-cover border-2 border-indigo-500/40 shrink-0"
                  />
            ...
            <div className="p-8 rounded-3xl bg-slate-900/60 border border-slate-800 space-y-4">
              <h2 className="text-xl font-bold font-heading text-white">Talablar & Tayyorgarlik</h2>
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-28 space-y-6">
              {/* Enrollment Box */}
              <div className="p-6 sm:p-8 rounded-3xl bg-slate-900 border border-indigo-500/30 shadow-2xl shadow-indigo-500/10 space-y-6">
                <div>
                  <div className="text-xs font-semibold text-slate-400 mb-1">Kurs to'lovi:</div>
                  {course.discountPrice ? (
                    <div>
                      ...
                      <div className="inline-block mt-1 px-2.5 py-0.5 rounded-md bg-emerald-500/10 text-emerald-400 text-xs font-bold border border-emerald-500/20">
                        Chegirma bilan
                      </div>
                    </div>
                  ) : (
                ...
                <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-2 text-xs text-slate-300">
                  <div className="flex justify-between">
                    <span className="text-slate-400">Dars jadvali:</span>
                    <span className="font-semibold text-white text-right">{course.schedule}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Guruh sig'imi:</span>
                    <span className="font-semibold text-white">10-12 kishi</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-400">Sinov darsi:</span>
                    <span className="font-bold text-emerald-400">BEPUL</span>
                  </div>
                </div>
                ...
                {isSent ? (
                  <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl text-center space-y-1">
                    ...
                    <div className="text-xs font-bold text-white">Arizangiz qabul qilindi!</div>
                    <div className="text-[11px] text-emerald-300">Tez orada siz bilan bog'lanamiz.</div>
                  </div>
                ) : (
                  <form onSubmit={handleFastSubmit} className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-700 rounded-xl p-3 text-xs text-white placeholder-slate-500 outline-none focus:border-indigo-500 font-mono"
                    />
                    <button
                      type="submit"
                      className="w-full py-3.5 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:to-pink-500 text-white font-bold text-xs sm:text-sm shadow-xl shadow-indigo-600/30 flex items-center justify-center gap-2 group transition-all"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {relatedCourses.map((rc) => (
                <div
                  ...
                  className="p-5 rounded-3xl bg-slate-900/60 border border-slate-800 hover:border-indigo-500/40 cursor-pointer transition-all hover:-translate-y-1 space-y-3 group"
                >
                  <img
                    src={rc.image}
                    alt={rc.title}
                  ...
                  />
                  <h3 className="font-heading font-bold text-sm text-white group-hover:text-indigo-300 transition-colors line-clamp-1">
                    {rc.title}
                  </h3>
